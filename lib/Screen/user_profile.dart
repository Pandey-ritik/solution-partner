...
class _MyScreenState extends State<MyScreen> {
  ...
  // FavouriteItmes itm=FavouriteItmes();
  @override
          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              PopupMenuButton<int>(
                ...
                itemBuilder: (context) => [
                  PopupMenuItem<int>(value: 0, child: Text('Block')),
                        ...
                        child: SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Icon(Icons.person),
                                        Text('150 Followers',style: TextStyle(fontWeight: FontWeight.bold),),
                                      ],
                                    ),
                                ...
                                // ),
                                Posts(
                                  content: 'In “High Cost Lifestyles Can Lead to Loss of Autonomy,”, Daniel Paull MD writes about bad long-term decisions made by many high-income earners because the need a lot of money for luxury purchases.',
                                ...
                                Posts(
                                    content: 'Meet Phil Zald, MD. A desire to help, heal and contribute to a better understanding of illness and its impact on patients’ lives led him to a career in medicine. As a board-certified otolaryngologist, he provides compassionate and state-of-the-art diagnosis and treatment tailored to individual patients.',
                                    profileurl: '${widget.profilePic}',
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: TextFormField(
                    ...
                    true, //set it true, so that user will not able to edit text
                    onTap: ()  {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>SlotBookingScreen(text1: timeinput1,)));
                    }
                ),
              ),
            ),
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: TextFormField(
                  ...
                  readOnly: true,
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>SlotBookingScreen(text1: timeinput2,)));
                  },
                ),
              ),
            ),
            ...
            children: [
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    FaIcon(
                      FontAwesomeIcons.comment, // replace with your comment icon path
...
class SlotBookingScreen extends StatefulWidget {
  SlotBookingScreen({required this.text1,});
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected1==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.grey,
                  ),
                )
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected2==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.grey,
                  ),
                )
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected3==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.grey,
                  ),
                )
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected4==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.grey,
                  ),
                )
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected5==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.grey,
                  ),
                )
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected6==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.grey,
                  ),
                )
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(isSelected7==true?'Booked':'Book',style: TextStyle(color: Colors.white),),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.grey,
                  ),
                )
