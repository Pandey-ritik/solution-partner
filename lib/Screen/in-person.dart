...
//                 ),
//                 SizedBox(height: 10,),
//                 Text('Morning Session',style:TextStyle(fontWeight: FontWeight.w400)),
//                 SizedBox(height: 20,),
//                 Row(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   mainAxisAlignment: MainAxisAlignment.start,
...
//                       child: Center(
//                         child: Text('8:00 AM',
//                           style: TextStyle(color: Color(0xFF01038A),),
//                         ),
//                       ),),
//                     SizedBox(width:30,),
//                     Container(height: 70,
...
//                 ),
//                 SizedBox(height: 10,),
//                 Text('Afternoon Session',style:TextStyle(fontWeight: FontWeight.w400)),
//                 SizedBox(height: 20,),
//                 Row(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   mainAxisAlignment: MainAxisAlignment.start,
...
//                         color:Colors.white70,
//                       ),
//                       child: Center(child: Text('6:00 PM',style: TextStyle(color: Color(0xFF01038A),),),),
//                     ),
//                     Spacer(),
//                     Padding(
//                       padding: const EdgeInsets.all(10),
...
//                 ),
//                 SizedBox(height: 20,),
//                 Text('Timing 2',style:TextStyle(fontWeight: FontWeight.w400)),
//                 SizedBox(height: 20,),
//                 Row(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   mainAxisAlignment: MainAxisAlignment.start,
...
//                         color:Colors.white70,
//                       ),
//                       child: Center(child: Text('6:00 PM',style: TextStyle(color: Colors.grey),),),
//                     ),
//                     Spacer(),
//                     Padding(
//                       padding: const EdgeInsets.all(10),
...
//                   ],
//                 ),
//                 Text('slot Duration',style:TextStyle(fontWeight: FontWeight.w400)),
//                 SizedBox(height: 20,),
//                 Container(
//                   height: 50,
